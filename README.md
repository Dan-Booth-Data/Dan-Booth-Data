...
| -- | -- | -- |
| [Airbnb search tool](https://github.com/Dan-Booth-Data/air_bnb_dbt_project) | Created an Airbnb search tool helping users find the proximity of Airbnb listings to London attractions | • Snowflake <br> • dbt <br> • Tableau |
